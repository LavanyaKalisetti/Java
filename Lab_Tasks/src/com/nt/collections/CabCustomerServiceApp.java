...
class CabCustomerService {
 ...
 public String printBill(CabCustomer customer) {
     ...
     return customer.getCustomerName().toUpperCase() + " Please pay your bill of Rs." + billAmount;
 }
}

//ELC: Main Class
public class CabCustomerServiceApp {
 public static void main(String[] args) {
     CabCustomerService service = new CabCustomerService();

     CabCustomer customer1 = new CabCustomer(1, "John", "LocationA", "LocationB", 5, "9999999999");
     System.out.println(service.printBill(customer1));
     service.addCabCustomer(customer1);

     CabCustomer customer2 = new CabCustomer(2, "Smith", "Loc1", "Loc2", 6, "9999999999");
     System.out.println(service.printBill(customer2));
     service.addCabCustomer(customer2);

     CabCustomer customer3 = new CabCustomer(3, "Alice", "LocX", "LocY", 3, "8888888888");
